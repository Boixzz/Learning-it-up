...
<body>
          ...
          <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <p style="text-align: center;">If you don't have an account Register <a href="#" data-bs-toggle="modal" data-bs-target="#register">Here</a></p>
                </div>
                
                <div class="modal-footer">
                    <button type="submit" class="btn btn-warning" name="btnlogin" onclick="return validatelogin(this.form)">Log in</button>
                </div>
            </form>
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <select class="form-select" name="Language">
                            <option value="" active hidden>Language</option>
                        ...
                        <div class="form-check">
                          ...
                          <p style="text-align: center;">If you already have an account login <a href="#" data-bs-toggle="modal" data-bs-target="#login">Here</a></p>
                    </div>
    
                    <div class="modal-footer">
                        <button name="registerbtn" type="submit" class="btn btn-warning" onclick="return validateform(this.form)">Submit</button>
                    </div>
                </form>
    ...
    <div class="container-fluid" id="features">
        ...
        <div class="row">
            ...
            <div class="col-sm-6" style="padding: 100px;">
                ...
                <button data-bs-toggle="modal" data-bs-target="#login" type="button" class="btn btn-warning">Join Now</button>
            </div>
        </div>
    </div>
    <div class="container-fluid">
    ...
    <div class="container-fluid" id="courses">
        ...
        <div class="container">
            ...
            <div class="row">
                    <?php
                        $sadmin=mysqli_query($conn,"SELECT * FROM course");
                ...
                <div class="card col-sm-3" style="margin: 10px; padding: 10px;">
                    ...
                    <div class="card-footer">
                        <a class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#login">Enroll Now</a>
                    </div>
