...
<body>
    ...
    <div class="cotaner-fluid" id="featured">
        ...
        <div class="container">
            ...
            <div class="row">
                    <?php
                        $sadmin=mysqli_query($conn,"SELECT c.CourseID,c.CourseName,c.InstrustorName,c.Prize,c.Cimg FROM course As c LEFT OUTER JOIN coursedetail As cd ON c.CourseID=cd.CourseID WHERE C.CourseID NOT IN (SELECT CourseID FROM coursedetail WHERE coursedetail.StudentID='$UserID') ORDER BY c.courseID desc Limit 6 ");
                        while($dtrecord=mysqli_fetch_assoc($sadmin)){
                            
                    ?>
                <div class="card col-sm-3" style="margin: 45px; padding: 10px;">
                    
                    <img style=" height: 200px;" class="card-img-top rounded" src="Cimg/<?php echo $dtrecord['Cimg'];?>" alt="card image">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <form method="post">
                            ...
                            <button class="btn btn-warning" name="enrollbtn" value="<?php echo $dtrecord['CourseID'];?>">Enroll Now</button>
                        </form>
                    </div>
    ...
    <div class="container-fluid" id="createcourse">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <label class="text-danger">Upload Image</label>
    ...
    <div class="container-fluid" id="uploadcoursefile">
    <div class="container" id="updatefile">
        <p class="h3" style="margin-top: 50px;">Upload Course File</p>
        <form method="post" enctype="multipart/form-data">
            <label class="text-danger">Upload Course Video</label>
            ...
            <button name="ucfbtn" type="submit" class="btn btn-warning">Upload Course</button>
        </form>
    </div>
    <hr>
    </div>
    ...
    <div class="container" id="yourlearning">
        ...
        <div class="container">
            <div class="row">
                    <?php
                        $sadmin=mysqli_query($conn,"SELECT * FROM coursedetail,course WHERE coursedetail.CourseID = course.CourseID AND coursedetail.StudentID ='$UserID'");
                        while($dtrecord=mysqli_fetch_assoc($sadmin)){
                    ?>
                <div class="card col-sm-3" style="margin: 45px; padding: 10px;">
                    ...
                    <div class="card-footer">
                        <form method="post">
                        <a style="cursor: pointer;" onclick="Enrollconfirm(<?php echo $dtrecord['CourseID'];?>)">
                            <button class="btn btn-success" name="learnbtn" value="<?php echo $dtrecord['CourseID'];?>">Learn</button>
                        </a>
                        </form>
                    </div>
    ...
    <script>
        ...
        if (UserType == 'Student'){
            ...
            var ucf=document.getElementById("uploadcoursefile").style.display='none';
        }
