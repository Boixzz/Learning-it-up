...
<head>
    ...
    <script>
        ...
        {
            xmlhttp=GetXnlHttpObject();
            if (xmlhttp==null)
            {
                alert("Your browser does not support AJAX");
                return;
            }
            var url="index.php?page=lan";
            url=url+"&q="+str;
        ...
        function stateChanged()
        {
            ...
            {
                document.getElementById("lan").innerHTML=xmlhttp.reponseText;
            }
        }
        function GetXmlHttpObject()
        {
            ...
            {
                return new ActiveObject("Microscoft")
            }
        }
    </script>
</head>
<body>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-warning" name="btnlogin">Edit</button>
                </div>
    ...
    <div class="container" id="updatefile">
        ...
        <form method="post">
            <input class="form-control" type="file" name="FileName" placeholder="Upload File">
            <select class="form-select" name="CourseName">
                <option active hidden>Course Name</option>
                <?php
                    $Courseselect=mysqli_query($conn,"SELECT DISTINCT(CourseName) FROM course");
            ...
            <select class="form-select" name="Language">
                <option active hidden>Language</option>
                <?php
                    $Languageselect=mysqli_query($conn,"SELECT * FROM course WHERE Languageselect ='$_REQUEST[q]'");
                    while($Language=mysqli_fetch_assoc($Languageselect))
                        {
                        ?>
                            <option value="<?php echo $Language['Language']; ?>">
